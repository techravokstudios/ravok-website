...
// Documents
export { storageUrl, getDocumentCategories, createDocumentCategory, updateDocumentCategory, deleteDocumentCategory, listInvestorDocuments, uploadInvestorDocuments, updateInvestorDocument, deleteInvestorDocument } from './api/v1/documents';
