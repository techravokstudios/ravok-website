...
export default function VentureModel() {
    return (
        <section id="model" className="py-24 lg:py-32 bg-ravok-charcoal text-white border-t border-white/5 relative overflow-hidden rounded-t-3xl shadow-2xl">
            ...
            <div className="absolute inset-0 z-0">
                ...
                />
                <div className="absolute inset-0 bg-gradient-to-b from-ravok-charcoal/60 via-ravok-charcoal/80 to-ravok-charcoal" />
            </div>
            ...
            <div className="container mx-auto px-6 grid lg:grid-cols-2 gap-16 items-center relative z-10">
                ...
                <FadeIn delay={0.5} className="hidden lg:block h-full min-h-[600px] relative">
                    ...
                    <div className="absolute inset-0 bg-gradient-to-l from-ravok-charcoal via-transparent to-transparent z-10" />
                    <img
                        src="/images/bg_1.png"
