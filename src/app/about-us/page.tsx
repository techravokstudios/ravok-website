    ...
    <main className="min-h-screen bg-[var(--ds-bg)] text-[var(--ds-ink)] selection:bg-ravok-gold selection:text-black overflow-x-hidden">
      ...
      <section className="min-h-screen flex flex-col justify-center relative px-6 pt-32 pb-24 overflow-hidden">
        ...
        <div className="container mx-auto relative z-10 max-w-5xl">
          <motion.h1
            className="text-[clamp(3rem,6.5vw,5.5rem)] font-heading font-normal leading-[1.05] text-center text-[var(--ds-ink)] uppercase tracking-[0.02em] mb-6"
          ...
          <motion.h2
            className="text-[clamp(3rem,6.5vw,5.5rem)] font-heading font-normal leading-[1.05] text-center text-ravok-gold uppercase tracking-[0.02em] mb-20"
            initial={{ opacity: 0, y: 32 }}
            animate={{ opacity: 1, y: 0 }}
        ...
        <div className="container mx-auto max-w-5xl relative z-10">
          <div className="grid lg:grid-cols-12 gap-12 lg:gap-16 items-start">
            ...
            >
              ...
              <span className="text-[var(--ds-ink)] font-sans text-base tracking-widest uppercase">
            ...
            <div className="lg:col-span-9">
              ...
              <motion.div
                className="space-y-8 text-[var(--ds-ink-dim)] font-sans text-lg lg:text-xl leading-relaxed"
                initial={{ opacity: 0, y: 20 }}
                whileInView={{ opacity: 1, y: 0 }}
                viewport={{ once: true }}
              ...
              >
                <p>
                  RAVOK&apos;s mission is simple: <strong className="text-[var(--ds-ink)] font-semibold">give filmmakers the same ownership and infrastructure that tech founders get.</strong>
                </p>
                <p>
      ...
      <section className="min-h-screen flex flex-col justify-center py-20 lg:py-24 px-6 border-t border-[var(--ds-border)] relative overflow-hidden">
        <div className="container mx-auto grid lg:grid-cols-2 gap-16 items-center">
          <motion.div
            className="relative order-2 lg:order-1 min-h-[400px] lg:min-h-[500px] rounded-2xl overflow-hidden border border-[var(--ds-border)]"
          ...
          >
            <div className="absolute inset-0 z-0">
              ...
              />
              <div className="absolute inset-0 bg-gradient-to-r from-[var(--ds-bg)] via-[rgba(28,28,26,0.4)] to-transparent lg:from-[rgba(28,28,26,0.8)]" />
            </div>
          ...
          <div className="order-1 lg:order-2 relative z-10 pl-0 lg:pl-8">
            ...
            <motion.h2
              className="text-[clamp(2.5rem,4.5vw,4rem)] font-heading font-normal text-ravok-gold leading-tight mb-10"
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
              transition={{ duration: 0.7 }}
            ...
            <motion.p
              className="text-[var(--ds-ink-dim)] font-heading text-xl lg:text-2xl leading-relaxed max-w-xl"
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
              transition={{ duration: 0.7, delay: 0.1 }}
      ...
      <section className="min-h-screen flex flex-col justify-center py-20 lg:py-24 px-6 border-t border-[var(--ds-border)] relative overflow-hidden">
        <div className="container mx-auto grid lg:grid-cols-2 gap-16 items-center">
          <div className="relative z-10">
            <motion.h2
              className="text-[clamp(2.5rem,4.5vw,4rem)] font-heading font-normal text-[var(--ds-ink)] leading-tight mb-14"
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
              transition={{ duration: 0.7 }}
            ...
            <div className="space-y-6">
              {[
                ...
                >
                  ...
                  <p className="text-[var(--ds-ink-dim)] font-sans text-lg lg:text-xl leading-relaxed">{item.body}</p>
                </motion.div>
              ))}
            </div>
            <motion.p
              className="mt-14 pl-6 text-[var(--ds-ink-dim)] font-sans text-lg lg:text-xl leading-relaxed max-w-xl italic"
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
              transition={{ duration: 0.7 }}
          ...
          <div className="relative hidden lg:block min-h-[500px] rounded-2xl overflow-hidden border border-[var(--ds-border)]">
            <img
              src="/images/2.png"
              alt=""
              className="w-full h-full object-cover object-center grayscale opacity-50"
            />
            <div className="absolute inset-0 bg-gradient-to-l from-[var(--ds-bg)] to-transparent" />
          </div>
        </div>
      </section>
      ...
      <section className="min-h-screen flex flex-col justify-center py-20 lg:py-24 px-6 border-t border-[var(--ds-border)]">
        <div className="container mx-auto max-w-5xl">
          <motion.h2
            className="text-[clamp(2.5rem,4.5vw,4rem)] font-heading font-normal text-ravok-gold text-center uppercase leading-tight mb-24"
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            transition={{ duration: 0.7 }}
          ...
          <div className="grid sm:grid-cols-2 gap-8 lg:gap-10">
            {[
              ...
              <motion.div
                key={i}
                className="group p-8 lg:p-10 rounded-xl border border-[var(--ds-border)] bg-[rgba(232,228,218,0.04)] hover:border-ravok-gold/40 hover:bg-[rgba(232,228,218,0.04)] hover:shadow-[0_0_60px_-12px_rgba(169,129,71,0.15)] transition-all duration-300 hover:-translate-y-1"
              ...
              >
                ...
                <p className="text-[var(--ds-ink-dim)] font-sans text-base lg:text-lg leading-relaxed">{item.body}</p>
              </motion.div>
            ))}
          </div>
        </div>
      ...
      <section className="min-h-screen flex flex-col justify-center py-20 lg:py-24 px-6 border-t border-[var(--ds-border)] relative">
        ...
        <div className="container mx-auto max-w-5xl relative z-10">
          <motion.h2
            className="text-[clamp(2.5rem,4.5vw,4rem)] font-heading font-normal text-ravok-gold text-center leading-tight mb-20"
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            transition={{ duration: 0.7 }}
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8 mb-16">
            {[
              ...
              <motion.div
                ...
                whileHover={{ y: -4 }}
              >
                <div className="mx-auto mb-4 w-fit rounded-full p-1 ring-2 ring-ravok-gold ring-offset-4 ring-offset-[var(--ds-bg)] shadow-[0_0_0_1px_rgba(255,255,255,0.08),0_8px_32px_rgba(0,0,0,0.4),0_0_48px_rgba(169,129,71,0.12)] transition-all duration-300 group-hover:ring-ravok-beige group-hover:shadow-[0_0_0_1px_rgba(255,255,255,0.1),0_12px_40px_rgba(0,0,0,0.5),0_0_64px_rgba(169,129,71,0.2)]">
                  <div className="w-40 h-40 rounded-full overflow-hidden bg-[rgba(232,228,218,0.08)] flex items-center justify-center relative">
                ...
                <h3 className="text-[var(--ds-ink)] font-heading text-xl uppercase tracking-wide">{member.name}</h3>
          ...
          <motion.p
            className="text-center text-[var(--ds-ink-dim)] font-sans text-lg lg:text-xl max-w-2xl mx-auto mb-14 leading-relaxed"
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            transition={{ duration: 0.6 }}
          ...
          >
            <Link
              href="/contact-us"
              className="inline-flex items-center gap-2 bg-ravok-gold text-black px-6 py-[0.85rem] rounded-full font-sans text-base font-semibold uppercase tracking-widest hover:bg-ravok-beige transition-colors"
            >
              Join us
      ...
      <section className="min-h-screen flex flex-col justify-center relative px-6 py-32 overflow-hidden">
        ...
        <div className="container mx-auto text-center relative z-10">
          <motion.h2
            className="text-[clamp(3rem,6.5vw,5.5rem)] font-heading font-normal text-[var(--ds-ink)] uppercase tracking-wide drop-shadow-lg"
            initial={{ opacity: 0, y: 24 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
          ...
          >
            <Link
              href="/contact-us"
              className="inline-flex items-center gap-2 border-2 border-ravok-gold text-ravok-gold px-6 py-[0.85rem] rounded-full font-sans text-base font-semibold uppercase tracking-widest hover:bg-ravok-gold hover:text-black transition-all duration-300 hover:shadow-[0_0_50px_rgba(169,129,71,0.35)]"
            >
              Get in touch
              <ChevronRight className="w-4 h-4" />
            </Link>
